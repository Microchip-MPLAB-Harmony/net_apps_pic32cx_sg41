...
|------------|-------------|------------------------|-----------|
|sam\_e54\_xpro.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the UDP Client and Server on development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This implementation is based on Bare Metal \( non-RTOS\).|
|sam\_e54\_xpro\_freertos.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the UDP Client and Server on development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This implementation is based on Freertos.|
