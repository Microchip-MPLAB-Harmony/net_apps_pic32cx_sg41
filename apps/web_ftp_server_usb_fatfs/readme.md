...
|------------|-------------|------------------------|-----------|
|sam\_e54\_xpro.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the TCP/IP Web and FTP Server with more than one FS on a development board with PIC32CX1025SG41128 device and on-board KSZ8091 PHY. This implementation is based on Bare-metal.|
|sam\_e54\_xpro\_freertos.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the TCP/IP Web Server with more than one FS on a development board with PIC32CX1025SG41128 device and on-board KSZ8091 PHY. This implementation is based on FreeRTOS.|
