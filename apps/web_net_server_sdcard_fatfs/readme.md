...
|------------|-------------|------------------------|-----------|
|sam\_e54\_xpro.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the web net server SDCARD FAT FS on development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This is a Bare Metal \(non-RTOS\) implementation.|
|sam\_e54\_xpro\_freertos.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the web net server SDCARD FAT FS on development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This is a FreeRTOS implementation.|
