...
|------------|-------------|------------------------|-----------|
|sam\_e54\_xpro.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the wolfSSL TCP Server on a development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This is a bare-metal \(non-RTOS\) implementation. WolfSSL Hardware crypto enabled|
|sam\_e54\_xpro\_freertos.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the wolfSSL TCP Server on development board with PIC32CX1025SG41128 device and KSZ8091 PHY daughter board. This implementation is based on Freertos.|
|sam\_e70\_xult\_sw.X|PIC32CX1025SG41128|ATSAM E54 Xplained pro|Demonstrates the wolfSSL TCP Server on a development board with PIC32CX1025SG41128 device with and KSZ8091 PHY daughter board. This is a bare-metal \(non-RTOS\) implementation. WolfSSL Software crypto enabled|
